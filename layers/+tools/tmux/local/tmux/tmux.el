...
(define-key evil-normal-state-map (kbd "H") #'tmux-nav-left)
(define-key evil-normal-state-map (kbd "U") #'tmux-nav-down)
(define-key evil-normal-state-map (kbd "K") #'tmux-nav-up)
(define-key evil-normal-state-map (kbd "L") #'tmux-nav-right)
(define-key evil-motion-state-map (kbd "H") #'tmux-nav-left)
(define-key evil-motion-state-map (kbd "U") #'tmux-nav-down)
(define-key evil-motion-state-map (kbd "K") #'tmux-nav-up)
(define-key evil-motion-state-map (kbd "L") #'tmux-nav-right)'
...
(when (boundp 'evil-evilified-state-map-original)
  ...
  (define-key evil-evilified-state-map-original (kbd "H") #'tmux-nav-left)
  (define-key evil-evilified-state-map-original (kbd "U") #'tmux-nav-down)
  (define-key evil-evilified-state-map-original (kbd "K") #'tmux-nav-up)
  (define-key evil-evilified-state-map-original (kbd "L") #'tmux-nav-right))
